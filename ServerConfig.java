 ...
 * This can be moved to an inner class of LegendarySavagesConfig, but is separate because of personal preference and to keep the code organised
 *
 * @author Cadiboo
 */
final class ServerConfig {
    ...
    final ForgeConfigSpec.BooleanValue serverReceiveRendezvousMessages;
    ...
    final ForgeConfigSpec.BooleanValue serverDebugLegend;
    ...
    ServerConfig(@Nonnull final ForgeConfigSpec.Builder builder) {
        ...
        electricFurnaceEnergySmeltCostPerTick = builder
                ...
                .translation(LegendarySavages.MODID + ".config.electricFurnaceEnergySmeltCostPerTick")
        ...
        heatCollectorTransferAmountPerTick = builder
                ...
                .translation(LegendarySavages.MODID + ".config.heatCollectorTransferAmountPerTick")
                .defineInRange("heatCollectorTransferAmountPerTick", 100, 0, Integer.MAX_VALUE);
        serverDebugLegend = builder
                .define("serverDebugLegend", false);
        builder.pop();
    }
}